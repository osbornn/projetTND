...
```{r partie2.4}
regRea = lm(apprentissage$deces_total~apprentissage$reanimation_total, data = covid.19)
regHos = lm(apprentissage$deces_total~apprentissage$hospitalises_total, data = covid.19)
regGue = lm(apprentissage$deces_total~apprentissage$gueris_total, data = covid.19)
