...
### On observe que la MAE et la MSE appliqués sur l'ensemble d'apprentissage donnent des résultats inférieurs aux résultats obtenus ### en appliquant la MAE et la MSE sur l'ensemble de test. En effet la MAE et MSE appliqués sur l'ensemble de test permettent de ### prédire les erreurs pour le modèle en question, donc les résultats sont plus élevés. On observe que la Min Aboslute Error 
### appliquée sur l'ensemble de test donne un résultat égal à 1340.958. On en déduit que l'on peut prédire le nombre de décès pour ### un département donné avec une précision de 1340.985.
...
```{r partie 3.3.2}
#da questa riga in poi mi da errore 
#K-means
