...
#### D'après l'analyse des résultats des trois parties on peut en déduire que toute la France métropolitaine a été touchée par l'épidémie ainsi que le taux de contagion, de guérison et d'hospitalisation augmentent avec le temps.
#### Le nombre de morts peut être prévu uniquement en analysant chaque département,
